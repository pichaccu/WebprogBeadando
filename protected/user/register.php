...
<form method="post">
	<div class="form-row">
		<div class="form-group col-md-6">
			<label for="registerFirstName">Vezeték név</label>
	...
	<div class="form-row">
		...
		<div class="form-group col-md-6">
			<label for="registerEmail1">Írd be újra az Email címet</label>
	...
	<div class="form-row">
		...
		<div class="form-group col-md-6">
			<label for="registerPassword1">Írd be újra a Jelszót</label>
